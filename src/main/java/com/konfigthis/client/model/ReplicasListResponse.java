...
public class ReplicasListResponse {
  ...
  private List<ReplicasListResponseDataInner> data = null;

  public ReplicasListResponse() {
  }

  public ReplicasListResponse data(List<ReplicasListResponseDataInner> data) {
  ...
  public ReplicasListResponse addDataItem(ReplicasListResponseDataInner dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public List<ReplicasListResponseDataInner> getData() {
    return data;
  }


  public void setData(List<ReplicasListResponseDataInner> data) {
   ...
   * @return the ReplicasListResponse instance itself
   */
  public ReplicasListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, replicasListResponse.data)&&
        Objects.equals(this.additionalProperties, replicasListResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReplicasListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReplicasListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ReplicasListResponseDataInner.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReplicasListResponse>() {
           ...
           public ReplicasListResponse read(JsonReader in) throws IOException {
             ...
             ReplicasListResponse instance = thisAdapter.fromJsonTree(jsonObj);
